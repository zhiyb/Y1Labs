...
#define CONCAT_DDR(n) CONCAT(DDR, n)
#define CONCAT_PORT(n) CONCAT(PORT, n)
#define CONCAT_PIN(n) CONCAT(PIN, n)
#define TFT_PCTRL	CONCAT_DDR(TFT_CPORT)
#define TFT_WCTRL	CONCAT_PORT(TFT_CPORT)
#define TFT_RCTRL	CONCAT_PIN(TFT_CPORT)
#define TFT_PDATA	CONCAT_DDR(TFT_DPORT)
#define TFT_WDATA	CONCAT_PORT(TFT_DPORT)
#define TFT_RDATA	CONCAT_PIN(TFT_DPORT)
