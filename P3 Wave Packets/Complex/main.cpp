...
int main(void)
{
	Sleep(100);		// Get ride of a wired warning message
#if 0
	//test();
	...
	sum *= 2.0 * L / N;
	cout << "Integration of psi * psi.conj() (t = 0) from " << -L << " to " << L << " with " << N << " steps:" << endl;
	cout << sum << endl;
